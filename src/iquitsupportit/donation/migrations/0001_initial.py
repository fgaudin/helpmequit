...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'donation_payment', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('quitter', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('beneficiary', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['quitter.Beneficiary'])),
            ('amount', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'donation', ['Payment'])


    def backwards(self, orm):
        # Deleting model 'Payment'
        db.delete_table(u'donation_payment')
    ...
    models = {
        ...
        u'donation.payment': {
            ...
            'beneficiary': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['quitter.Beneficiary']"}),
