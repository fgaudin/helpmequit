...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Beneficiary.banner_font_theme'
        db.add_column(u'quitter_beneficiary', 'banner_font_theme',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=10, blank=True),
                      keep_default=False)

        # Adding field 'Beneficiary.banner_copyright'
        db.add_column(u'quitter_beneficiary', 'banner_copyright',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Beneficiary.banner_font_theme'
        db.delete_column(u'quitter_beneficiary', 'banner_font_theme')

        # Deleting field 'Beneficiary.banner_copyright'
        db.delete_column(u'quitter_beneficiary', 'banner_copyright')
    ...
    models = {
        ...
        u'quitter.beneficiary': {
            ...
            'banner_copyright': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '255', 'blank': 'True'}),
            'banner_font_theme': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '10', 'blank': 'True'}),
