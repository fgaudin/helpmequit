...
class Migration(SchemaMigration):
    ...
    depends_on = (
        ("auth2", "0004_users_username"),
    )

    def forwards(self, orm):
        # Deleting field 'Profile.hash'
        db.delete_column(u'quitter_profile', 'hash')


    def backwards(self, orm):
        # Adding field 'Profile.hash'
        db.add_column(u'quitter_profile', 'hash',
