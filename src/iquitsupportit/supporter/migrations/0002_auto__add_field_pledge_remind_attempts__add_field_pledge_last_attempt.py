...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Pledge.remind_attempts'
        db.add_column(u'supporter_pledge', 'remind_attempts',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Pledge.last_attempt'
        db.add_column(u'supporter_pledge', 'last_attempt',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Pledge.remind_attempts'
        db.delete_column(u'supporter_pledge', 'remind_attempts')

        # Deleting field 'Pledge.last_attempt'
        db.delete_column(u'supporter_pledge', 'last_attempt')
    ...
    models = {
        ...
        u'supporter.pledge': {
            ...
            'remind_attempts': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
