...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Beneficiary.banner'
        db.add_column(u'quitter_beneficiary', 'banner',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Beneficiary.banner'
        db.delete_column(u'quitter_beneficiary', 'banner')
