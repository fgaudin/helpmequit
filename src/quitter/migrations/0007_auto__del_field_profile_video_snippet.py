...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Profile.video_snippet'
        db.delete_column(u'quitter_profile', 'video_snippet')


    def backwards(self, orm):
        # Adding field 'Profile.video_snippet'
        db.add_column(u'quitter_profile', 'video_snippet',
