...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Profile.video_embed_url'
        db.add_column(u'quitter_profile', 'video_embed_url',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Profile.picture'
        db.add_column(u'quitter_profile', 'picture',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Profile.video_embed_url'
        db.delete_column(u'quitter_profile', 'video_embed_url')

        # Deleting field 'Profile.picture'
        db.delete_column(u'quitter_profile', 'picture')
    ...
    models = {
        ...
        u'quitter.beneficiary': {
            ...
            'banner_font_theme': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '10'}),
        ...
        u'quitter.profile': {
            ...
            'video_embed_url': ('django.db.models.fields.URLField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
